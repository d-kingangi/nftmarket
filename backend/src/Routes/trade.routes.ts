...
import { create_nftmarket_trade, get_nftmarket_trades_for_buyer, get_nftmarket_trades_for_collection, get_nftmarket_trades_for_project, get_single_nftmarket_trade,  update_nftmarket_trade, delete_nftmarket_trade } from "../Controllers/trade.controller";
...
tradeRoute.get('/:unique_trade_id', get_single_nftmarket_trade)
