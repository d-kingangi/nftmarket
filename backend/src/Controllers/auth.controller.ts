...
export const login_nftmarket_user = async (req: Request, res: Response) => {
    try {
        ...
        .execute("login_nftmarket_user")).recordset
...
export const reset_nftmarket_user_password = async (req:Request, res:Response) => {
    try {
        const {email, password} = req.body
        ...
        .input("email", email)
        .input("password", password)
        .execute("reset_nftmarket_user_password")).rowsAffected
...
export const logout_nftmarket_user = (req: Request, res: Response) => {
